...
public class InsertUsagesNonRTDASImpl extends BddUsagesNonRTDAS implements InsertUsagesNonRTDAS {

	private final static Logger LOG = LogManager.getLogger(InsertUsagesNonRTDASImpl.class);
	...
	@Override
	public void insert(String usage, String name, HashMap<String, Parc> usageMap, int pasdeTemps, int annee) {

		List<Object[]> objectInsert = new ArrayList<Object[]>();
		Object[] object = null;

		for (String parcKey : usageMap.keySet()) {
			Parc besoinUsage = usageMap.get(parcKey);
