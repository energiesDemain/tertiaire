...
public interface FinanceService {
	...
	HashMap<String, PartMarcheRenov> renovationSegmentGlobal(HashMap<String, BigDecimal> decretMemory,
		 ...
		 HashMap<String, Parc> parcTotMap, ResultConsoRt resultConsoRt, int annee, int anneeNTab, HashMap<String,CalibCoutGlobal> coutIntangible,
			HashMap<String,CalibCoutGlobal> coutIntangibleBati, ParamCintObjects paramCintObject,
