...
wbfiles[2]  = "../tertiaire/model/Result_csv/publi_thema/sensib_AMS_lambda20pmoins"
wbfiles[3]  = "../tertiaire/model/Result_csv/publi_thema/sensib_AMS_DV30"
...
wbname =c("S0 Nopol","S1 lambda","S2 DV30","S4 AMS",  paste0("S",5:(length(wbfiles))))

### choix du scenario de référence 

scenario_ref =c("S0 Nopol")
scenario_toexport = c("S1 lambda")
scenario_sansCEE = c("S1 lambda")
scenario_comp_AMS = c("S0 Nopol","S1 lambda","S2 DV30","S4 AMS")

wbdir_scenario_toexport = c("../publication_thema/run_AMS/")
write_excel =F

scenarioshortnames = substring(wbname,1,2)
scenarioshortnames = c("S0 Nopol","S1 lambda","S2 DV30","S4 AMS", paste0("S",4:(length(wbfiles))))
scenarioshortnames = wbname


scenariolabels = c("S0 Nopol" = "Nopol", "S1 lambda" = "lambda", 
                  "S2 DV30"= "DV30","S4 AMS" = "AMS")
...
ggplot(comp_consoCEREN_energie_usage[usage=="Chauffage" & scenario !="S0 Nopol"]) + 
...
ggsave("../publication_thema/figures/comp_consoCEREN_energie_chauffage_sensib.pdf",width = 14, height=12)

ggsave("../publication_thema/présentation/comp_consoCEREN_energie_chauffage_sensib.png",width = 14, height=12)
...
Em_nationale_energie_type_usage[scenario =="S0 Nopol",EmMtCO2_socio := conso_tWhEF*FE_AME*10^9*10^-12]
Em_nationale_energie_type_usage[scenario !="S0 AMS",EmMtCO2_socio := conso_tWhEF*FE_AMS*10^9*10^-12]
Em_nationale_energie_usage[scenario =="S0 Nopol",EmMtCO2_socio := conso_tWhEF*FE_AME*10^9*10^-12]
Em_nationale_energie_usage[scenario !="S0 Nopol",EmMtCO2_socio := conso_tWhEF*FE_AMS*10^9*10^-12]
...
Evol_Em_usage = dcast.data.table(Em_nationale_usage [annee%in%c("2015","2020","2025","2030","2035","2050")], scenario+usage~annee, value.var = "EmMtCO2_socio")

Evol_Em_usage = Evol_Em_usage[,list(scenario,usage,
                Evol_2015 = paste0(round((get("2015")/get(annee_ref2)-1)*100, digits=1), " %"),
                Evol_2020 = paste0(round((get("2020")/get(annee_ref2)-1)*100, digits=1), " %"),
                Evol_2020 = paste0(round((get("2025")/get(annee_ref2)-1)*100, digits=1), " %"),
                Evol_2030 = paste0(round((get("2030")/get(annee_ref2)-1)*100, digits=1), " %"),
...
```{r, echo=F, warning=F,}
pander(Evol_Em_usage[usage=="Chauffage"], caption = "Evolution des émissions liées au chauffage")
```
...
bilan_socio[scenario!="S0 Nopol" & energie == "Electricité",sub_elec := conso_tWhEF*Taxe_elec*10^-3]
...
table_results_socio = data.table(scenario = c("Nopol","RenovIni","DV30","AMS")) 

## facture
table_results_socio[scenario!= "Nopol",Fact :=bilan_socio_cum2[scenario != "S0 Nopol",Depense_socio_AMS_actu] ]
table_results_socio[scenario == "Nopol",Fact :=bilan_socio_cum2[scenario == "S0 Nopol",Depense_socio_AME_actu] ]

## INV
table_results_socio[scenario!= "Nopol",INV :=bilan_socio_cum2[scenario != "S0 Nopol", INV_Md_actu] ]
table_results_socio[scenario == "Nopol",INV :=bilan_socio_cum2[scenario == "S0 Nopol",INV_Md_actu] ]

## EMissions
table_results_socio[scenario!= "Nopol",Em :=bilan_socio_cum2[scenario != "S0 Nopol",Emiss_Mt_AMS_actu] ]
table_results_socio[scenario == "Nopol",Em :=bilan_socio_cum2[scenario == "S0 Nopol",Emiss_Mt_AME_actu] ]
...
#### recettes taxes
table_results_socio[scenario!= "Nopol",TC :=bilan_socio_cum2[scenario != "S0 Nopol",Recettes_TC_AMS_actu] ]
table_results_socio[scenario == "Nopol",TC :=bilan_socio_cum2[scenario == "S0 Nopol",Recettes_TC_AME_actu] ]

table_results_socio[scenario!= "Nopol",Taxes_ener :=bilan_socio_cum2[scenario != "S0 Nopol",Recettes_taxes_ener_AMS_actu] ]
table_results_socio[scenario == "Nopol",Taxes_ener :=bilan_socio_cum2[scenario == "S0 Nopol",Recettes_taxes_ener_AME_actu] ]

table_results_socio[scenario == "Nopol",sub_elec :=bilan_socio_cum2[scenario == "S0 Nopol",Subvention_elec_actu] ]
table_results_socio[scenario!= "Nopol",sub_elec :=bilan_socio_cum2[scenario != "S0 Nopol",Subvention_elec_actu] ]
...
## facture
table_results_usager[scenario!= "Nopol",Fact :=bilan_usager_cum2[scenario != "S0 Nopol",Depense_usager_AME_actu] ]
table_results_usager[scenario == "Nopol",Fact :=bilan_usager_cum2[scenario == "S0 Nopol",Depense_usager_AMS_actu] ]

## INV
table_results_usager[scenario!= "Nopol",INV :=bilan_usager_cum2[scenario != "S0 Nopol", INV_Md_actu] ]
table_results_usager[scenario == "Nopol",INV :=bilan_usager_cum2[scenario == "S0 Nopol",INV_Md_actu] ]

## EMissions
table_results_usager[scenario!= "Nopol",Em :=bilan_usager_cum2[scenario != "S0 Nopol",Emiss_Mt_AME_actu] ]
table_results_usager[scenario == "Nopol",Em :=bilan_usager_cum2[scenario == "S0 Nopol",Emiss_Mt_AMS_actu] ]
...
# bilan_usager_cum[, Diff_AMS_AME := get("S0 Nopol")-get("S2 AME")]
# 
