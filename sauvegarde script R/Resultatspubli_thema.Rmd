...
#wbfiles  = "../tertiaire/model/Result_csv/publi_thema/prix_constant_nopol"
# wbfiles[2]  = "../tertiaire/model/Result_csv/publi_thema/prix_AME_noTC"
#wbfiles  = "../tertiaire/model/Result_csv/publi_thema/prix_AME_TC"
#wbfiles  = "../tertiaire/model/Result_csv/publi_thema/prix_AME_TC_verif"
wbfiles = "../tertiaire/model/Result_csv/publi_thema/2050_AME_final_verif"
# wbfiles[5]  = "../tertiaire/model/Result_csv/publi_thema/prix_AME_CEEseulcroiss1p"
# wbfiles[6]  = "../tertiaire/model/Result_csv/publi_thema/prix_AME_CEEseulcroiss2p"
# wbfiles[7]  = "../tertiaire/model/Result_csv/publi_thema/prix_AME_lambda1en2050"
# wbfiles[8]  = "../tertiaire/model/Result_csv/publi_thema/prix_constant_lambda1en2050"
...
wbname = c("Réf","PC_Nopol","PC_TC100","PC_TC600",  paste0("S",5:(length(wbfiles))))

### choix du scenario de référence 

scenario_ref =c("Réf")
scenario_toexport = c("Réf")
scenario_sansCEE = c( "Réf")
scenario_comp_AMS = c("Réf","PC_Nopol","PC_TC100","PC_TC600")

wbdir_scenario_toexport = c("../AME_AMS_dataDGEC/AMS 2018/run 4 new model/")
wbdir_scenario_toexport = c("../publication_thema/run_Nopol/")
wbdir_scenario_toexport = c("../publication_thema/run_prixAMETC_nopol/")
write_excel =T

scenarioshortnames = substring(wbname,1,2)
scenarioshortnames = c("Réf","PC_Nopol","PC_TC100","PC_TC600",  paste0("S",4:(length(wbfiles))))
scenarioshortnames = wbname


scenariolabels = c("P0_Nopol" = "Réf", wbname[2:length(wbname)])
...
parc_occupant = merge(parc_melted, COD_OCCUPANT[, list(OCCUPANT,occupation = COD_OCCUPANT)], by="occupation")
parc_occupant = parc_occupant[annee=="2010", sum(Surface), by="OCCUPANT"]
parc_occupant[,Part_occupant := V1/sum(V1)]
``` 
...
```{r parc_periode_2010_ref, fig.width=18, fig.height=12, echo=F, warning=F,fig.cap='Comparaison avec le parc CEREN par branche', dev=c('png', 'pdf'),  fig.show='hold'}
...
ggsave("../publication_thema/présentation/ParcPeriode2010.png",width = 14, height=12)
...
ggsave("../publication_thema/présentation/ParcPeriodeBranche2010.png",width = 18, height=12)
...
ggsave("../publication_thema/présentation/ParcEnergie2010.png",width = 14, height=12)
...
ggsave("../publication_thema/présentation/ParcEnergieBranche2010.png",width = 18, height=12)
...
ggsave("../publication_thema/présentation/CompParcCEREN2010.png",width = 14, height=12)



ggplot(comp_parc_par_branche[an %in% annee_CEREN & BRANCHE != "Total général" & scenario %in% c(scenario_ref) & 
                               an == "2010"], 
       aes(scenario,Surf, fill = branchenom)) + scale_x_discrete(label = scenariolabels)+
           geom_bar(stat="identity", show.legend  = F) + 
#           facet_wrap(~an, nrow = 1) + 
 # geom_text(aes(label=paste0(part, " %")),position = position_stack(vjust = 0.5), colour = "white", fontface = "bold", size = 7) +
  geom_text(aes(label=paste0(branchenom, " : ", part, " %")),position = position_stack(vjust = 0.5), colour = "white", fontface = "bold", size = 7) +
  theme(axis.text.x = element_text(size = 12, hjust = 1,angle =45), title  = element_text(size = 20)) + 
  ylab("Millions de m²")+ xlab("")+ scale_y_continuous(breaks = seq(0,1000,200), limits = c(0,1000))+
  mytheme_facet_plot + scale_fill_brewer("", palette = "Set2")
ggsave("../publication_thema/présentation/CompParcCEREN2010_2.png",width = 10, height=12)
...
ggsave("../publication_thema/présentation/CompParcEnergieCEREN2010.png",width = 14, height=12)
...
#### Evol 2009-2015
Evol_chauffage = comp_consoCEREN_energie_usage[, list(sum(conso_tWhEF)), by=c("annee","scenario", "usage")]
Evol_chauffage = dcast.data.table(Evol_chauffage, scenario + usage~ annee)
Evol_chauffage[, Evol09_15 := get("2015")/get("2009") -1 ]
Evol_chauffage[, Evol10_15 := get("2015")/get("2010") -1 ]
```
...
ggplot(comp_consoCEREN_energie[annee != "2009"],aes(scenario,conso_tWhEF, fill = energie) ) + 
           geom_bar(stat="identity") + 
facet_wrap(~annee, nrow = 1) +
...
ggsave("../publication_thema/figures/CompConsoTot.pdf",width = 10, height=12)
ggsave("../publication_thema/présentation/CompConsoTot.png",width = 10, height=12)
...
ggsave("../publication_thema/présentation/CompConsoTot2010.png",width = 10, height=12)

ggplot(comp_consoCEREN_energie[annee == "2010" & scenario  == "Réf"],aes(scenario,conso_tWhEF, fill = energie) ) + 
           geom_bar(stat="identity", show.legend = F) + 
#           facet_wrap(~annee, nrow = 1) +
  theme(axis.text.x = element_text(size = 12, hjust = 1,angle =45))+ ylab("TWh")+
  geom_text(aes(label=paste0(energie," : ", part,  " %")),position = position_stack(vjust = 0.5), colour = "white", fontface = "bold", size = 7)+
  mytheme_facet_plot + xlab("") + scale_fill_manual("", values = color_energie$color[1:4]) +
   scale_x_discrete(label = scenariolabels) + scale_y_continuous(breaks = seq(0,250,50),limits =c(0,250))

ggsave("../publication_thema/présentation/CompConsoTot2010_2.png",width = 8, height=12)
...
ggplot(comp_consoCEREN_energie_usage[annee == "2010"],aes(scenario,conso_tWhEF, fill = energie) ) + 
  ...
  mytheme_facet_plot + xlab("") + scale_fill_manual("", values = color_energie$color[1:4]) +
   scale_x_discrete(label = scenariolabels) + scale_y_continuous(breaks = seq(0,120,20),limits =c(0,120))

ggsave("../publication_thema/figures/CompConsousage2010.pdf",width = 14, height=12)
ggsave("../publication_thema/présentation/CompConsousage2010.png",width = 14, height=12)

ggplot(comp_consoCEREN_energie_usage[annee == "2010" & usage=="Chauffage" & scenario =="Réf"],aes(scenario,conso_tWhEF, fill = energie) ) + 
           geom_bar(stat="identity", show.legend = F) + 
           facet_wrap(~usage, nrow = 1, label = labeller(usage = label_wrap_gen(10))) +
  theme(axis.text.x = element_blank(), axis.text.y = element_text(size =30), strip.text = element_text(size =30))+ ylab("TWh")+
  geom_text(aes(label=paste0(energie, " : ", part)),position = position_stack(vjust = 0.5), colour = "white", fontface = "bold", 
            size =12)+
  mytheme_facet_plot + xlab("") + scale_fill_manual("", values = color_energie$color[1:4]) +
   scale_x_discrete(label = scenariolabels) + scale_y_continuous(breaks = seq(0,120,20),limits =c(0,120))

ggsave("../publication_thema/présentation/ConsoChauff2010.png",width = 10, height=12)
...
ggplot(comp_consoCEREN_energie_usage[usage=="Chauffage" & annee != "2009"]) + 
...
ggsave("../publication_thema/figures/comp_consoCEREN_energie_chauffage.pdf",width = 14, height=12)
ggsave("../publication_thema/présentation/comp_consoCEREN_energie_chauffage.png",width = 14, height=12)
...
ggsave("../publication_thema/présentation/CompConsobranche2010.png",width = 14, height=12)
...
ggsave("../publication_thema/présentation/Consobranche2010.png",width =7 , height=12)
ggplot(comp_consoCEREN_branche[annee == "2010" & scenario == "Réf"],aes(scenario,conso_tWhEF, fill = nom_branche) ) + 
           geom_bar(stat="identity", show.legend = F) + 
#           facet_wrap(~usage, nrow = 1, label = labeller(usage = label_wrap_gen(10))) +
  theme(axis.text.x = element_text(size = 12, hjust = 1,angle =45))+ ylab("TWh")+
  geom_text(aes(label=paste0(nom_branche, " : ", part, " %")),position = position_stack(vjust = 0.5), colour = "white", fontface = "bold", size = 7)+
  mytheme_facet_plot + xlab("") + scale_fill_brewer("", palette = "Set2")  +
   scale_x_discrete(label = scenariolabels) + scale_y_continuous(breaks = seq(0,250,50),limits =c(0,250))
ggsave("../publication_thema/présentation/Consobranche2010_2.png",width = 8, height=12)
```
...
ggsave("../publication_thema/présentation/ConsoUsage2010.png",width = 7, height=12)
...
#           facet_wrap(~usage, nrow = 1, label = labeller(usage = label_wrap_gen(10))) +
  theme(axis.text.x = element_text(size = 12, hjust = 1,angle =45))+ ylab("TWh")+
  geom_text(aes(label=paste0(usage , " : ", part, " %")),position = position_stack(vjust = 0.5), colour = "white", fontface = "bold", size = 7)+
  mytheme_facet_plot + xlab("") + scale_fill_brewer("", palette = "Set2")  +
   scale_x_discrete(label = scenariolabels) + scale_y_continuous(breaks = seq(0,250,50),limits =c(0,250))

ggsave("../publication_thema/présentation/ConsoUsage2010_2.png",width = 8, height=12)
...
ggsave("../publication_thema/présentation/PMsyst2010.png",width =12 , height=12)

ggplot(PM_syst_2010, aes(scenario,PM_syst, fill = SYSTEME_CHAUD)) +
           geom_bar( stat="identity",  show.legend  = F) +
           ### facet_wrap(~scenario, nrow = 1) + 
              geom_text(data= PM_syst_2010[PM_syst >0.02],
                        aes(label = paste0(SYSTEME_CHAUD, " : ",Part_graph)),
                        position = position_stack(vjust = 0.5, reverse =F), colour = "white", fontface = "bold", size = 10)+
            xlab("")+ylab("Part dans le parc total")+
           mytheme_facet_plot +
  scale_fill_manual("Système de chauffage",values=unique(PM_syst_2010$color),
                    guide = guide_legend(ncol=2))  

ggsave("../publication_thema/présentation/PMsyst2010_2.png",width = 10, height=18)
...
ggsave("../publication_thema/présentation/Conso_u_Branche.png",width = 18, height=12)
...
```{r Etiquette_ini, fig.width=25, fig.height=10, echo=F, warning=F,fig.cap='Parts de marché des énergies dans les consommations de chauffage du parc existant (pour DGEC)', dev=c('png', 'pdf')}
...
ggsave("../publication_thema/présentation/Parcetiqbranche.png",width = 18, height=12)

ggplot(etiq_BRANCHE ,aes(x="",part, fill = ETIQUETTE) ) + 
           geom_bar(stat="identity", position = "stack") + 
           facet_wrap(~BRANCHE, nrow = 1, label = labeller(BRANCHE = label_wrap_gen(10))) +
  theme(axis.text.x = element_text(size = 14, hjust = 1,angle =45))+ ylab("% de la Branche")+
  geom_text(aes(label=partgraph),position = position_stack(vjust = 0.5), fontface = "bold", size = 7)+
  mytheme_facet_plot + xlab("") + scale_y_continuous(breaks = seq(0,100,20),limits =c(0,101))+scale_fill_brewer("étiquette", palette = "RdYlGn", direction = -1) 

ggsave("../publication_thema/présentation/Parcetiqbranche_2.png",width = 18, height=12)
