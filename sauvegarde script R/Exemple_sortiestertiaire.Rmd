...
wbfiles  = "../Sauvegardes_resultats_thema/avec_calib_CODAH/2050_nopol_prixconstant"
#wbfiles  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_nopol_prixcroissants_noRT2012"
wbfiles[2]  = "../Sauvegardes_resultats_thema/avec_calib_CODAH/2050_nopol_prixcroissants"
wbfiles[3]  = "../Sauvegardes_resultats_thema/avec_calib_CODAH/2050_AME_nouveauxprix"
wbfiles[4]  = "../Sauvegardes_resultats_thema/avec_calib_CODAH/2050_AMS2_sansdecarb"
#wbfiles[3]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_AMS_nosubENR"
wbfiles[5]  = "../Sauvegardes_resultats_thema/avec_calib_CODAH/2050_AMS1_biog150"
wbfiles[6]  = "../Sauvegardes_resultats_thema/avec_calib_CODAH/2050_AMS2"
...
scenario_toexport_list = c("S0 P0",
           "S0b REF",
           "S1 AME",
#           "S7 AMS1 Dec0",
           "S4 AMSDec0",
...
wbdir_scenario_toexport = c("../sauvegarde script R/export_sorties_test/")
...
#### taxes - subventions sur les énergies, y compris composante carbone, en euros par kwh

taxes_usager_2018 = data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema_clean_prix_constant_2018.xls", sheet ="taxes_ener_AME"))
...
taxes_usager_AME = data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema_clean.xls", sheet = "taxes_ener_AME"))
taxes_usager_AMS = data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema.xls", sheet =  "taxes_ener_AMS"))
taxes_usager_AMS1 = data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema_clean.xls", sheet = "taxes_ener_AMS1"))
taxes_usager_AMS2 = data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema_clean.xls", sheet = "taxes_ener_AMS2"))
taxes_usager_AMS1GJ = data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema_clean_giletsjaunes.xls", sheet = "taxes_ener_AMS1"))
taxes_usager_AMS2GJ = data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema_clean_giletsjaunes.xls", sheet = "taxes_ener_AMS2"))
taxes_usager_AMS1nodecarb = data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema_clean_sansdecarb.xls", sheet = "taxes_ener_AMS1"))
taxes_usager_AMS2nodecarb = data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema_clean_sansdecarb.xls", sheet = "taxes_ener_AMS2"))

taxes_usager_2018 =melt(taxes_usager_2018, id.vars = c("annee"),variable.name = "energie",value.name = "taxes_usager_2018")
taxes_usager_Nopol =melt(taxes_usager_Nopol, id.vars = c("annee"),variable.name = "energie",value.name = "taxes_usager_Nopol")
taxes_usager_AME= melt(taxes_usager_AME, id.vars = c("annee"),variable.name = "energie",value.name = "taxes_usager_AME")
taxes_usager_AMS= melt(taxes_usager_AMS, id.vars = c("annee"),variable.name = "energie",value.name = "taxes_usager_AMS")
taxes_usager_AMS1= melt(taxes_usager_AMS1, id.vars = c("annee"),variable.name = "energie",value.name = "taxes_usager_AMS1")
taxes_usager_AMS2= melt(taxes_usager_AMS2, id.vars = c("annee"),variable.name = "energie",value.name = "taxes_usager_AMS2")
taxes_usager_AMS1GJ= melt(taxes_usager_AMS1GJ, id.vars = c("annee"),variable.name = "energie",value.name = "taxes_usager_AMS1GJ")
taxes_usager_AMS2GJ= melt(taxes_usager_AMS2GJ, id.vars = c("annee"),variable.name = "energie",value.name = "taxes_usager_AMS2GJ")
taxes_usager_AMS1nodecarb = melt(taxes_usager_AMS1nodecarb, id.vars = c("annee"),variable.name = "energie",value.name = "taxes_usager_AMS1nodecarb")
taxes_usager_AMS2nodecarb = melt(taxes_usager_AMS2nodecarb, id.vars = c("annee"),variable.name = "energie",value.name = "taxes_usager_AMS2nodecarb")

taxes_usager = merge(taxes_usager_2018,taxes_usager_AME,by=c("annee","energie"))
taxes_usager = merge(taxes_usager,taxes_usager_Nopol,by=c("annee","energie"))
taxes_usager = merge(taxes_usager,taxes_usager_AMS,by=c("annee","energie"))
taxes_usager = merge(taxes_usager,taxes_usager_AMS1,by=c("annee","energie"))
taxes_usager = merge(taxes_usager,taxes_usager_AMS2,by=c("annee","energie"))
taxes_usager = merge(taxes_usager,taxes_usager_AMS1GJ,by=c("annee","energie"))
taxes_usager = merge(taxes_usager,taxes_usager_AMS2GJ,by=c("annee","energie"))
taxes_usager = merge(taxes_usager,taxes_usager_AMS1nodecarb,by=c("annee","energie"))
taxes_usager = merge(taxes_usager,taxes_usager_AMS2nodecarb,by=c("annee","energie"))

#### composante carbone

CC = data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema_clean.xls", sheet = "CC"))
CC_GJ= data.table(read_excel("../publication_thema/hypothèses_prix/Prix_scenario_thema_clean_giletsjaunes.xls", sheet = "CC"))
CC= merge(CC, CC_GJ[,list(annee,CC_AMSGJ = CC_AMS)], by="annee")
...
# FICHE RESULTATS PUBLICATION THEMA AVEC BILAN
...
wbCEREN <- loadWorkbook("../sauvegarde suivi scenarios DGEC 2017/parametrage modele/Publication_donnees_CEREN_2015.xlsx", create = F)
...
ceren_details <- fread("../../../CEREN/exportCEREN_Branche_usage_energie_tertiaire.csv",sep=";", header=T, dec=",")
...
```{r Evol_prix_scen, fig.width=22, fig.height=12, echo=F, warning=F,fig.cap='Prix des énergies', dev=c('png', 'pdf')}
...
ggplot(prix_usager2 ) + 
  ...
  ylab("euros/MWh")+xlab("")+ 
  scale_color_manual("",values = color_energie$color) +  mytheme_facet_plot +
 theme(axis.text = element_text(size = 20), legend.text = element_text(size = 30))
```
...
ggplot(Conso_nationale_usage[,list(conso_tWhEF = sum(conso_tWhEF)),by=c("scenario","annee")]) +
  geom_line(aes(annee, conso_tWhEF, group=scenario,color= scenario), size = 3) +
     mytheme_facet_plot  + ylab("Consommmation en Twh") +
...
#### par energie
comp_AMS = fread("../sauvegarde suivi scenarios DGEC 2017/AMS 2018/cibleAMS.csv", dec = ",")
...
conso_unitaire_ensemble = conso_unitaire[,list(conso_u = sum(conso_tWhEF*10^9)/sum(surface)), by=c("scenario","annee")]
...
conso_u_graph = conso_unitaire_ensemble_usage_EF[usage == "Chauffage" & annee == "2015" & scenario == scenario_P0,list(scenario,conso_u)]

conso_u_graph = rbind(conso_u_graph,conso_unitaire_usage[annee %in% c("2050") & usage == "Chauffage" & scenario == scenario_P0 & Type_parc == "E", list(scenario,conso_u)])

conso_u_graph = rbind(conso_u_graph,conso_unitaire_ensemble_usage_EF[usage == "Chauffage" & annee == "2050" & scenario %in% scenario_order,list(scenario,conso_u)])


conso_u_graph[, scenario := factor(scenario, levels=scenario_order)]
conso_u_graph= conso_u_graph[order(scenario)]

conso_u_graph[, scenario2 := 
                factor(c("2015","2050 existant Prix constant","2050 Prix constant","2050 prix REF","2050 AME","2050 AMSDec0"),
                       levels = c("2015",
                                  "2050 existant Prix constant",
                                  "2050 Prix constant",
                                  "2050 prix REF",
                                  "2050 AME",
                                  "2050 AMSDec0"),
...
```{r Conso_u_Chauff_evol, fig.width=25, fig.height=10, echo=F, warning=F,fig.cap='Décomposition de la consommation unitaire de chauffage en 2050', dev=c('png', 'pdf')}
if(check_perf == T & graph_evol_conso_u == T) {
ggplot(conso_u_graph ,aes(x=scenario2,conso_u)) + 
  ...
  ylab("Kwh par m²")+
  geom_text(aes(label = scenario2),position = position_stack(vjust = 0.5), colour = "white", fontface = "bold", size = 11)+
  mytheme_facet_plot + xlab("")+scale_fill_brewer("Usage", palette = "Set3") 
}
#ggsave("../publication_thema/figures/Conso_u_Chauff_evol.png",width = 24, height=12)
...
```{r, echo=F, warning=F,}
if(check_perf == T) {
pander(dcast.data.table(conso_unitaire_ensemble[annee %in% c("2015","2020","2030","2035","2050")], scenario  ~ annee, value.var = "conso_u"), digits = 0, caption = "Consommations unitaires en kWh par m² d'énergie finale pour l'ensemble du parc et l'ensemble des usages")
}
```
...
<!-- if(check_perf == T) { -->
<!-- ggplot(conso_unitaire_branche_type[annee == "2009" & scenario == scenario_ref],aes(x="",conso_u, fill = usage) ) + -->
<!--            geom_bar(stat="identity", position = "stack") + -->
...
if(check_perf == T) {
ggplot(conso_unitaire_branche_type[(annee %in% c("2009") &  scenario == scenario_ref) | (annee == "2050"& scenario %in% scenario_consoubranche), list(conso_u = sum(conso_tWhEF, na.rm=T)/sum(surface, na.rm=T)*10^9), by=c("scenario","annee","usage","nom_branche")],aes(x=paste(annee,scenario, sep= " "),conso_u, fill = usage) ) +
           geom_bar(stat="identity", position = "stack") +
           facet_wrap(~nom_branche, nrow = 1, label = labeller(nom_branche = label_wrap_gen(10))) +
  theme(axis.text.x = element_text(size = 12, hjust = 1,angle =45))+ ylab("Kwh par m²")+
#  geom_text(aes(label=conso_u),position = position_stack(vjust = 0.5), colour = "white", fontface = "bold", size = 7)+
...
Evol_Em_chauff = dcast.data.table(Em_nationale_usage[annee%in%c("2015","2020","2025","2030","2035","2050") & usage == "Chauffage"], scenario~annee, value.var = "EmMtCO2")

annee_ref2 = "2015"

Evol_Em_chauff  = Evol_Em_chauff[,list(scenario,
                Evol_2015 = paste0(round((get("2015")/get(annee_ref2)-1)*100, digits=1), " %"),
                Evol_2020 = paste0(round((get("2020")/get(annee_ref2)-1)*100, digits=1), " %"),
                Evol_2020 = paste0(round((get("2025")/get(annee_ref2)-1)*100, digits=1), " %"),
                Evol_2030 = paste0(round((get("2030")/get(annee_ref2)-1)*100, digits=1), " %"),
...
```{r, echo=F, warning=F,}
if(check_Em == T) {
pander(Evol_Em_chauff, caption = "Evolution des émissions de chauffage")
}
```
...
```{r, echo=F, warning=F,}
 if(check_bilan_socio==T){
pander(table_results_socio, caption = "bilan pour la société", digits= 4)
 }
```
