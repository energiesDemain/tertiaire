...
wbfiles[2] = "../tertiaire/model/Result_csv/calage_cout_geste/NRFlambdacroissantparbranche_coutsystmodif2"
wbfiles[3] = "../tertiaire/model/Result_csv/calage_cout_geste/New_AME_test"
wbfiles[4] = "../tertiaire/model/Result_csv/calage_cout_geste/calage_cout_syst_DV30"
...
comp_consoCEREN_energie =rbind(comp_consoCEREN_energie  ,consotot_energie_CEREN[annee%in%as.character(2010:2015)])
...
comp_consoCEREN_energie_usage[usage %in% c("Bureautique","Auxiliaires","Ventilation","Eclairage","Froid_alimentaire", "Process"), usage2 := "Electricité spécifique"]
...
comp_consoCEREN_energie_usage =rbind(comp_consoCEREN_energie_usage  ,conso_energie_usage_CEREN[annee%in%as.character(2010:2015)])
