...
wbfiles[3] =  
"../tertiaire/model/Result_Excel/parametrage_octobre/table_resultat_2050_allpol_calparcener_calconsoener.xlsx"

wbfiles[4] =  
"../tertiaire/model/Result_Excel/parametrage_octobre/table_resultat_2015_allpol_sansCEE.xlsx"

wbfiles[5] =  
"../tertiaire/model/Result_Excel/parametrage_octobre/table_resultat_2015_allpol_sansCEE_calbranche.xlsx"
wbfiles[6] =  
...
#wbfiles[9] =
#"../tertiaire_to_export/resultats_AME_run2/2050_allpol_CEE/table_resultat_2050_allpol_calparcener_calconsoener.xlsx"
...
#### noms des scenarios ###
wbname = c("S1 : AME 2016","S2 : AME 2017 run1","S3 : AME 2017 run2",
           "S4 : AME 2017 run2 sans cal",
           "S5 : AME 2017 run2 cal branche",
           "S6 : AME 2017 run2 cal branche + ener",
           "S7 : AME 2017 run2 cal conso chauff",
           "S7b  : AME 2017 run2 cal conso chauff2",
           "S8 : AME 2017 run2 all pol sans CEE", 
           "S9 : AME 2017 run2 all pol avec CEE et CC"
...
scenario_ref = c("S8 : AME 2017 run2 all pol sans CEE")
scenario_toexport = c("S8 : AME 2017 run2 all pol sans CEE")
...
#### lecture des besoins et consos par usage branche et énergie pour le scénrio à exporter

Besoin_RT_wb = loadWorkbook(paste0(wbdir_scenario_besoins,"export_BESOIN_RT.xlsx"), create = F)
Besoin_RT = data.table(readWorksheet(Besoin_RT_wb, "Sheet0"))
Besoin_RT[,scenario := scenario_toexport]

Conso_NON_RT_wb = loadWorkbook(paste0(wbdir_scenario_besoins,"export_CONSO_NON_RT.xlsx"), create = F)
Conso_NON_RT = data.table(readWorksheet(Conso_NON_RT_wb, "Sheet0"))

### usages non rt conso_tot = besoin_tot en EF
Conso_NON_RT[,BESOIN_TOT := CONSO_TOT]
Conso_NON_RT[,scenario := scenario_toexport]

#### ON empile les besoins  et les consos pour tous les usage
Besoin_branche_usage_energie = rbind(Besoin_RT,Conso_NON_RT)
setnames(Besoin_branche_usage_energie, c("COD_BRANCHE","annee","usage","COD_ENERGIE","CONSO_TOT","BESOIN_TOT","scenario"))

#### idem par periode de construction
Besoin_RT_PERIODE_wb = loadWorkbook(paste0(wbdir_scenario_besoins,"export_BESOIN_RT_PERIODE.xlsx"), create = F)
Besoin_RT_PERIODE = data.table(readWorksheet(Besoin_RT_PERIODE_wb, "Sheet0"))
Besoin_RT_PERIODE[,scenario := scenario_toexport]

Conso_NON_RT_PERIODE_wb = loadWorkbook(paste0(wbdir_scenario_besoins,"export_CONSO_NON_RT_PERIODE.xlsx"), create = F)
Conso_NON_RT_PERIODE = data.table(readWorksheet(Conso_NON_RT_PERIODE_wb, "Sheet0"))

### usages non rt conso_tot = besoin_tot en EF
Conso_NON_RT_PERIODE[,BESOIN_TOT := CONSO_TOT]
Conso_NON_RT_PERIODE[,scenario := scenario_toexport]

#### ON empile les besoins  et les consos pour tous les usage
Besoin_branche_usage_energie_periode = rbind(Besoin_RT_PERIODE,Conso_NON_RT_PERIODE)
setnames(Besoin_branche_usage_energie_periode, c("COD_BRANCHE","annee","COD_PERIODE_SIMPLE","usage","COD_ENERGIE","CONSO_TOT",
                                                 "BESOIN_TOT","scenario"))

### verif periode de construction
unique(Besoin_branche_usage_energie_periode[annee =="2009",COD_PERIODE_SIMPLE])
unique(Besoin_branche_usage_energie_periode[annee =="2010",COD_PERIODE_SIMPLE])
unique(Besoin_branche_usage_energie_periode[annee =="2016",COD_PERIODE_SIMPLE])
unique(Besoin_branche_usage_energie_periode[annee =="2021",COD_PERIODE_SIMPLE])
unique(Besoin_branche_usage_energie_periode[annee =="2031",COD_PERIODE_SIMPLE])
unique(Besoin_branche_usage_energie_periode[annee =="2041",COD_PERIODE_SIMPLE])

#### Verif conso tot
verif_conso = merge(Besoin_branche_usage_energie[,sum(CONSO_TOT)/10^9,by=c("annee")],
Conso[scenario == scenario_toexport,sum(value)/10^9,by="annee"],by="annee")
verif_conso = merge(verif_conso, Besoin_branche_usage_energie_periode[,sum(CONSO_TOT)/10^9,by=c("annee")])

verif_conso_chauff = merge(Besoin_branche_usage_energie [usage=="Chauffage", sum(CONSO_TOT)/10^9, by=c("annee")],
Conso[usage=="Chauffage" & scenario == scenario_toexport,sum(value)/10^9,by="annee"],by="annee")
verif_conso_chauff = merge(verif_conso_chauff,Besoin_branche_usage_energie_periode[usage=="Chauffage", sum(CONSO_TOT)/10^9, by=c("annee")],
by="annee")
  
verif_conso_clim = merge(Besoin_branche_usage_energie [usage=="Climatisation", sum(CONSO_TOT)/10^9, by=c("annee")],
Conso[usage=="Climatisation" & scenario == scenario_toexport,sum(value)/10^9,by="annee"],by="annee")
verif_conso_clim = merge(verif_conso_clim ,Besoin_branche_usage_energie_periode[usage=="Climatisation", sum(CONSO_TOT)/10^9, by=c("annee")],
by="annee")
#### lecture des surfaces climati

Surf_clim_wb = loadWorkbook(paste0(wbdir_scenario_besoins,"export_SURFACES_CLIM.xlsx"), create = F)
Surf_clim = data.table(readWorksheet(Surf_clim_wb, "Sheet0"))
Surf_clim[,scenario := scenario_toexport]
...
Besoin_branche_usage_energie[COD_BRANCHE  == "02", Branche_MEDPRO := "Commerce" ]
Besoin_branche_usage_energie[COD_BRANCHE  == "03", Branche_MEDPRO := "Autre" ]
...
Besoin_branche_usage_energie_periode[COD_BRANCHE  == "02", Branche_MEDPRO := "Commerce" ]
Besoin_branche_usage_energie_periode[COD_BRANCHE  == "03", Branche_MEDPRO := "Autre" ]
...
Surf_clim[COD_BRANCHE == "01", Branche_MEDPRO := "Bureaux" ]
Surf_clim[COD_BRANCHE  == "02", Branche_MEDPRO := "Commerce" ]
Surf_clim[COD_BRANCHE  == "03", Branche_MEDPRO := "Autre" ]
Surf_clim[COD_BRANCHE  == "04", Branche_MEDPRO := "Autre" ]
Surf_clim[COD_BRANCHE  == "05", Branche_MEDPRO := "Autre" ]
Surf_clim[COD_BRANCHE  == "06", Branche_MEDPRO := "Santé" ]
Surf_clim[COD_BRANCHE == "07", Branche_MEDPRO := "Autre" ]
Surf_clim[COD_BRANCHE  == "08", Branche_MEDPRO := "Autre" ]
Surf_clim[,Branche_MEDPRO := factor(Branche_MEDPRO,levels =c("Bureaux","Commerce","Santé","Autre"))]
...
summary(Besoin_branche_usage_energie_periode$Usage_MEDPRO)
summary(Besoin_branche_usage_energie_periode$Usage_MEDPRO2)
...
summary(Besoin_branche_usage_energie_periode$Usage_MEDPRO)
summary(Besoin_branche_usage_energie_periode$Usage_MEDPRO2)
summary(Besoin_branche_usage_energie$Usage_MEDPRO)
summary(Besoin_branche_usage_energie$Usage_MEDPRO2)
...
Surf_clim[COD_PERIODE_SIMPLE  %in% c("01","02","03"), Type_parc := "E"]
Surf_clim[!(COD_PERIODE_SIMPLE  %in% c("01","02","03")), Type_parc := "N"]

Surf_clim[COD_PERIODE_SIMPLE  %in% c("01","02","03","04"), Type_parc_MEDPRO := "E"]
Surf_clim[!(COD_PERIODE_SIMPLE  %in% c("01","02","03","04")), Type_parc_MEDPRO := "N"]
...
* AME 2018 new calib all pol - CEE : version recalibrée du modèle et ajouts des mesures supplémentaires sans les CEE
* AME 2018 new calib all pol : version recalibrée du modèle et ajouts des mesures supplémentaires avec les CEE (version actuelle scénario AME 2017)

Principaux changements avec la version précédente du modèle :

* Recalage de la construction neuve à partir de la fiche envoyée par EnerData (ancien AME). Prolongement des tcam 2030-2035 jusque 2050

* Recalage du parc initial par branche sur le parc du CEREN en 2010. Recalage des besoins totaux en énergie en conservant les mêmes besoins unitaires.
...
* Recalibration des taux de rénovation par geste pour les rendre plus sensibles au prix. Suppression du taux de rénovation tendanciel (les taux de passage à l'acte sont suffisants en année initiale, plus nécessaire de les forcer)
...
* Hausse de 1.1% du taux de rénovation tendanciel après 2017 pour simuler les travaux embarqués
...
* Ajouts des CEE par un signal prix et calage (non définitif) pour retrouver les économies d'énergies visées par la DGEC. Arrêt du signal prix en 2021. 
...
calage_parc_2010[, calage := calage_parc_2010[,3]/calage_parc_2010[,7]]
calage_parc_2010[, calage2 := calage_parc_2010[,3]/calage_parc_2010[,8]]
...
calage_parc_ener_2010 [, calage :=calage_parc_ener_2010 [,3]/calage_parc_ener_2010 [,8]]

calage_parc_ener_2010 [, calage2 :=calage_parc_ener_2010 [,3]/calage_parc_ener_2010 [,9]]
calage_parc_ener_2010 [, calage3 :=calage_parc_ener_2010 [,3]/calage_parc_ener_2010 [,10]]
...
calage_parc_ener_2013 [, calage :=calage_parc_ener_2013 [,3]/calage_parc_ener_2013 [,8]]
calage_parc_ener_2013 [, calage2 :=calage_parc_ener_2013 [,3]/calage_parc_ener_2013 [,9]]
calage_parc_ener_2013 [, calage3 :=calage_parc_ener_2013 [,3]/calage_parc_ener_2013 [,10]]

```


```{r comp_parc_CEREN, fig.width=20, fig.height=13, echo=F, warning=F,fig.cap='Comparaison avec le parc CEREN par branche', dev=c('png', 'pdf')}
...
```{r comp_parc_CEREN_ener, fig.width=20, fig.height=13, echo=F, warning=F,fig.cap='Comparaison avec le parc CEREN par énergie de chauffage', dev=c('png', 'pdf')}
...
calage_conso_ener_2010[, calage :=calage_conso_ener_2010[,3]/calage_conso_ener_2010[,7]]
calage_conso_ener_2010[, calage2 :=calage_conso_ener_2010[,3]/calage_conso_ener_2010[,8]]
calage_conso_ener_2010[, calage3 :=calage_conso_ener_2010[,3]/calage_conso_ener_2010[,9]]
...
calage_conso_ener_2013[, calage :=calage_conso_ener_2013[,3]/calage_conso_ener_2013[,7]]
calage_conso_ener_2013[, calage2 :=calage_conso_ener_2013[,3]/calage_conso_ener_2013[,8]]
calage_conso_ener_2013[, calage3 :=calage_conso_ener_2013[,3]/calage_conso_ener_2013[,9]]
...
calage_consoChauff_ener_2010[, calage :=calage_consoChauff_ener_2010[,3]/calage_consoChauff_ener_2010[,7]]
calage_consoChauff_ener_2010[, calage2 :=calage_consoChauff_ener_2010[,3]/calage_consoChauff_ener_2010[,8]]
calage_consoChauff_ener_2010[, calage3 :=calage_consoChauff_ener_2010[,3]/calage_consoChauff_ener_2010[,9]]
...
calage_consoChauff_ener_2013[, calage :=calage_consoChauff_ener_2013[,3]/calage_consoChauff_ener_2013[,7]]
calage_consoChauff_ener_2013[, calage2 :=calage_consoChauff_ener_2013[,3]/calage_consoChauff_ener_2013[,8]]
calage_consoChauff_ener_2013[, calage3 :=calage_consoChauff_ener_2013[,3]/calage_consoChauff_ener_2013[,9]]
...
calage_consouChauff_2010[, calage :=calage_consouChauff_2010[,3]/calage_consouChauff_2010[,7]]
calage_consouChauff_2010[, calage2 :=calage_consouChauff_2010[,3]/calage_consouChauff_2010[,8]]
...
calage_consouChauff_2013[, calage :=calage_consouChauff_2013[,3]/calage_consouChauff_2013[,7]]
calage_consouChauff_2013[, calage2 :=calage_consouChauff_2013[,3]/calage_consouChauff_2013[,8]]
...
calage_consoAutres_ener_2010[, calage :=calage_consoAutres_ener_2010[,3]/calage_consoAutres_ener_2010[,7]]
calage_consoAutres_ener_2010[, calage2 :=calage_consoAutres_ener_2010[,3]/calage_consoAutres_ener_2010[,8]]
calage_consoAutres_ener_2010[, calage3 :=calage_consoAutres_ener_2010[,3]/calage_consoAutres_ener_2010[,9]]
...
##### besoin nationales par branche desag et usage 
...
Surf_clim[COD_SYSTEME_FROID == "01", Isclim := "Climatisé"]
Surf_clim[COD_SYSTEME_FROID  == "02", Isclim := "non climatisé"]

PM_clim_branche = Surf_clim[, list(Surface = sum(SURFACES_TOT)),by=c("scenario","annee","Branche_MEDPRO","Isclim")]

PM_clim_branche = PM_clim_branche[, list(Surface = sum(Surface),Isclim, PM_clim = Surface/sum(Surface)),by=c("scenario","annee","Branche_MEDPRO")]

PM_clim_branche = dcast.data.table(PM_clim_branche, scenario + Isclim +Branche_MEDPRO ~ annee, value.var = "PM_clim")

PM_clim_type_branche = Surf_clim[, list(Surface = sum(SURFACES_TOT)),by=c("scenario","annee","Type_parc","Branche_MEDPRO","Isclim")]
...
pander(PM_clim_type_branche[Isclim ==  "Climatisé" & Type_parc =="N" ,
                                colnames(PM_clim_type_branche)[colnames(PM_clim_type_branche) %in% c("scenario","Branche_MEDPRO","2010",annee_MEDPRO)], with=F], 
...
Surface_parc_Etat_tot[scenario == scenario_toexport]
Surface_parc_Etat_arenov[scenario == scenario_toexport]
Surface_parc_Renov_Etat[scenario == scenario_toexport]
Surface_parc_Renov_Etat_perf[scenario == scenario_toexport]

Surface_parc_Renov_Etat_perf_Regl[scenario == scenario_toexport]
...
writeWorksheet(wb,TabparcDGEC[scenario == scenario_toexport,], sheet = "Sorties_modele_tertiaire", startRow =4)
writeWorksheet(wb,construction_tot[scenario == scenario_toexport], sheet = "Sorties_modele_tertiaire", startRow =10)
writeWorksheet(wb,PM_ener_neuf[scenario == scenario_toexport], sheet = "Sorties_modele_tertiaire", startRow =14)
writeWorksheet(wb,Surfaces_ener_neuf[scenario == scenario_toexport], sheet = "Sorties_modele_tertiaire", startRow =22)
writeWorksheet(wb,PM_syst_neuf[scenario == scenario_toexport] , sheet = "Sorties_modele_tertiaire", startRow =30)
writeWorksheet(wb,Surfaces_syst_neuf[scenario == scenario_toexport] , sheet = "Sorties_modele_tertiaire", startRow =51)

writeWorksheet(wb,PM_clim_type_branche[Isclim ==  "Climatisé" & Type_parc =="N" & scenario == scenario_toexport,
                                colnames(PM_clim_type_branche)[colnames(PM_clim_type_branche) %in% c("scenario","Branche_MEDPRO",annee_MEDPRO)], with=F], sheet = "Sorties_modele_tertiaire", startRow =81)

writeWorksheet(wb,PM_clim_type_branche[Isclim ==  "Climatisé" & Type_parc =="E" & scenario == scenario_toexport ,
                                colnames(PM_clim_type_branche)[colnames(PM_clim_type_branche) %in% c("scenario","Branche_MEDPRO",annee_MEDPRO)], with=F], sheet = "Sorties_modele_tertiaire", startRow =88)

writeWorksheet(wb,tab_PM_geste[scenario == scenario_toexport], sheet = "Sorties_modele_tertiaire", startRow =95)
writeWorksheet(wb,PM_energie_exi[scenario == scenario_toexport], sheet = "Sorties_modele_tertiaire", startRow =103)
...
writeWorksheet(wb,Surface_parc_Renov_Etat_Regl[scenario == scenario_toexport], sheet = "Sorties_modele_tertiaire", startRow =119)

writeWorksheet(wb,conso_elec_DGEC[scenario == scenario_toexport,c("scenario","2010","2015","2020","2025","2030","2035","2040","2045","2050"),with=F], sheet = "Sorties_modele_tertiaire", startRow =123)
...
writeWorksheet(wb,tab_PM_energie_branche[PM_usage == "PM_Usages_thermiques" &  ENERGIE == "Gaz" & scenario == scenario_toexport,
                               c("scenario","Branche_MEDPRO",annee_MEDPRO), with=F], sheet = "Sorties_modele_tertiaire", startRow =127)

writeWorksheet(wb,tab_PM_energie_branche[PM_usage == "PM_Usages_thermiques" &  ENERGIE == "Urbain" &scenario == scenario_toexport, 
                               c("scenario","Branche_MEDPRO",annee_MEDPRO), with=F], sheet = "Sorties_modele_tertiaire", startRow =134)

writeWorksheet(wb,tab_PM_energie_branche[PM_usage == "PM_Usages_thermiques" &  ENERGIE == "Electricité"&scenario == scenario_toexport,
                               c("scenario","Branche_MEDPRO",annee_MEDPRO), with=F], sheet = "Sorties_modele_tertiaire", startRow =141)

writeWorksheet(wb,tab_PM_energie_branche[PM_usage == "PM_Usages_thermiques" &  ENERGIE == "Fioul" &scenario == scenario_toexport,
                               c("scenario","Branche_MEDPRO",annee_MEDPRO), with=F], sheet = "Sorties_modele_tertiaire", startRow =148)

writeWorksheet(wb,tab_PM_energie_branche[PM_usage == "PM_Usages_thermiques" &  ENERGIE == "Autres" & scenario == scenario_toexport,
                               c("scenario","Branche_MEDPRO",annee_MEDPRO), with=F], sheet = "Sorties_modele_tertiaire", startRow =155)

writeWorksheet(wb,evolbesoinu_usage_type[usage == "Chauffage" & scenario == scenario_toexport], sheet = "Sorties_modele_tertiaire", startRow =162)

writeWorksheet(wb,evolbesoinu_branche_usage[usage == "Autres usages thermiques" & scenario == scenario_toexport ,
                               c("scenario","Branche",annee_MEDPRO), with=F], sheet = "Sorties_modele_tertiaire", startRow =167)

writeWorksheet(wb,evolbesoinu_branche_usage[usage == "Electricité spécifique" & scenario == scenario_toexport ,
                               c("scenario","Branche",annee_MEDPRO), with=F], sheet = "Sorties_modele_tertiaire", startRow =174)

writeWorksheet(wb,evolbesoinu_branche_usage[usage == "Climatisation" & scenario == scenario_toexport ,
                               c("scenario","Branche",annee_MEDPRO), with=F], sheet = "Sorties_modele_tertiaire", startRow =181)

writeWorksheet(wb,PM_clim_branche[Isclim ==  "Climatisé" & scenario == scenario_toexport,
                               colnames(PM_clim_branche)[colnames(PM_clim_branche) %in% c("scenario","Branche_MEDPRO",annee_MEDPRO)], with=F], sheet = "Sorties_modele_tertiaire", startRow =188)

writeWorksheet(wb,besoin_elec_clim_medpro[scenario == scenario_toexport,colnames(besoin_elec_clim_medpro) %in% c("scenario","Branche_MEDPRO",annee_MEDPRO), with=F], sheet = "Sorties_modele_tertiaire", startRow =195)

writeWorksheet(wb,evolbesoin_clim_medpro[scenario == scenario_toexport], sheet = "Sorties_modele_tertiaire", startRow =202)


writeWorksheet(wb,conso_parenergie_mtep[scenario == scenario_toexport, c("scenario","energie","2010","2015","2020","2025","2030","2035","2050"), with=F], sheet = "Sorties_modele_tertiaire", startRow =206)

writeWorksheet(wb,conso_parusage_mtep[scenario == scenario_toexport ,c("scenario","usage","2010","2015","2020","2025","2030","2035","2050"), with=F], sheet = "Sorties_modele_tertiaire", startRow =214)


writeWorksheet(wb,Tab_inv_DGEC[scenario == scenario_toexport ,c("scenario","Type_Inv","2010","2015","2020","2025","2030","2035","2040","2045","2050"), with=F], sheet = "Sorties_modele_tertiaire", startRow =224)
