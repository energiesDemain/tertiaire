...
wbfiles[5]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_CC600seule_Dec50"
wbfiles[6]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_CC600toutesenergies_Dec50"
...
scenariolabels = c("S0 REF" = "REF",
                   ...
                   "S2 CC600+" = "CC 600+",
                   "S3 Dec50" = "Dec50",
                   "S4 CC600Dec50" ="CC600Dec50"  ,
                   "S5 CC600+Dec50" ="CC600+Dec50")
...
CC_to_use = data.table(scenario=wbname,CC=c("CC_Nopol","CC_600","CC_600","CC_Nopol","CC_600","CC_600"))
                       
CC_toutes_ener = data.table(scenario=wbname,CC=c(F,F,T,F,F,T))


#### prix et taxes à utiliser
prix_usager_to_use = data.table(scenario=wbname,prix=c(
  "prix_usager_Nopol","prix_usager_CC600","prix_usager_CC600+", "prix_usager_NopolDec50","prix_usager_CC600Dec50","prix_usager_CC600+Dec50"))
...
tax_to_use = data.table(scenario=wbname,taxe=c(
  ...
  "taxes_usager_CC600Dec50",
  "taxes_usager_CC600+Dec50"))
...
# FICHE RESULTATS PUBLICATION THEMA EVALUATION COMPOSANTE CARBONE AVEC BILAN
...
Em_nationale_usage_type_prolong = Em_nationale_energie_type_usage
Em_nationale_usage_type_prolong[annee=="2050",EmMtCO2:=EmMtCO2*10]
...
Cumul_Em_2015_60_chauffage_existant=Em_nationale_usage_type_prolong[annee%in%2015:2060 & usage=="Chauffage",sum(EmMtCO2), by=c("scenario", "Type_parc")]
...
setnames(table_results_usager, c("Scénario","Investissements","Conso","Facture","Coût total","Facture (Conso REF)","Coût total (Conso REF)"))
