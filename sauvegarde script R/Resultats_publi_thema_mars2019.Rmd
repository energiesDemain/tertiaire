...
wbfiles[2]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_AME_nouveauxprix"
wbfiles[3]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_AMS_nosubENR"
wbfiles[4]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_AMS1_biog150"
wbfiles[5]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_AMS1_gilets_jaunes"
wbfiles[6]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_AMS2"
wbfiles[7]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_AMS2_gilets_jaunes"
wbfiles[8]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_AMS1_sansdecarb"
wbfiles[9]  = "../tertiaire/model/Result_csv/publi_thema/avec_calib_CODAH/2050_AMS2_sansdecarb"
...
FE_to_use=data.table(scenario=wbname,FE=c("FE_AME","FE_AME", "FE_AMS","FE_AMS", "FE_AMSGJ","FE_AMS","FE_AMSGJ","FE_AME","FE_AME"))

#### composante énergie à utiliser par scénario 
CC_to_use = data.table(scenario=wbname,FE=c("CC_AMSGJ","CC_AME", "CC_AMS","CC_AMS", "CC_AMSGJ","CC_AMS","CC_AMSGJ","CC_AMS","CC_AMS"))

#### prix et taxes à utiliser
prix_usager_to_use = data.table(scenario=wbname,FE=c("prix_usager_2018","prix_usager_AME", 
                                                     "prix_usager_AMS",
                                                     "prix_usager_AMS1","prix_usager_AMS1GJ",
                                                     "prix_usager_AMS2","prix_usager_AMS2GJ"))

tax_to_use = data.table(scenario=wbname,FE=c("taxes_usager_2018","taxes_usager_AME",
                                             "taxes_usager_AMS",
                                             "taxes_usager_AMS1", "taxes_usager_AMS1GJ",
                                             "taxes_usager_AMS2","taxes_usager_AMS2GJ"))
...
# 
prix_ener_socio[annee %in% c(2015, 2030,2050)]
prix_ener_socio_AMS[annee %in% c(2015, 2030,2050)]

FE[annee %in% c(2015, 2030,2050) & usage == "Chauffage"]
