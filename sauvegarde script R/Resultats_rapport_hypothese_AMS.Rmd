...
wbfiles[3]  = "../tertiaire/model/Result_csv/publi_thema/2050_AMS_final"

####### noms des scenarios ########

wbname = c( paste0("S",1:length(wbfiles)))
  
wbname = c("S0 Nopol","S1 AME","S2 AMS",  paste0("S",4:(length(wbfiles))))

### choix du scenario de référence 

scenario_ref =c("S0 Nopol")
scenario_toexport = c("S2 AMS")
scenario_sansCEE = c( "S0 Nopol")
scenario_comp_AMS = c("S0 Nopol","S1 AME","S2 AMS")

wbdir_scenario_toexport = c("../publication_thema/run_AMS/")
write_excel =T

scenarioshortnames = substring(wbname,1,2)
scenarioshortnames = c("S0 Nopol","S1 AME","S2 AMS", paste0("S",4:(length(wbfiles))))
scenarioshortnames = wbname


scenariolabels = c("S0 Nopol" = "Nopol",
                   "S1 AME"= "AME","S3 AMS"="AMS")
...
Em_nationale_energie_type_usage[scenario =="S2 AMS",EmMtCO2_socio := conso_tWhEF*FE_AMS*10^9*10^-12]
Em_nationale_energie_type_usage[scenario !="S2 AMS",EmMtCO2_socio := conso_tWhEF*FE_AME*10^9*10^-12]
Em_nationale_energie_usage[scenario =="S2 AMS",EmMtCO2_socio := conso_tWhEF*FE_AMS*10^9*10^-12]
Em_nationale_energie_usage[scenario !="S2 AMS",EmMtCO2_socio := conso_tWhEF*FE_AME*10^9*10^-12]
