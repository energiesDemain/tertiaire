...
wbfiles  = "../tertiaire/model/Result_csv/publi_thema/2050_AMS_final"
# wbfiles[5]  = "../tertiaire/model/Result_csv/publi_thema/2050_AMS_variante091_surfaces"
# wbfiles[2]  = "../tertiaire/model/Result_csv/sensib_AMS/sensib1_prix"
# wbfiles[3]  = "../tertiaire/model/Result_csv/sensib_AMS/sensib2_population"
# wbfiles[4]  = "../tertiaire/model/Result_csv/sensib_AMS/sensib3_CCE"
# wbfiles[5]  = "../tertiaire/model/Result_csv/sensib_AMS/sensib4_efficacité"
# wbfiles[6]  = "../tertiaire/model/Result_csv/sensib_AMS/sensib5_sanscomportement"
# wbfiles[7]  = "../tertiaire/model/Result_csv/sensib_AMS/sensib6_comportementsplus"
# wbfiles[8]  = "../tertiaire/model/Result_csv/sensib_AMS/sensib7_investissement"
wbfiles[2]  = "../tertiaire_versionAMS2/model/Result_csv/sensib_AMS/sensib8_sanstaxecarbone"
wbfiles[3]  = "../tertiaire_versionAMS2/model/Result_csv/sensib_AMS/sensib8bis_sanstaxecarbone_biogaz50_sansCompoEner"
wbfiles[4]  = "../tertiaire_versionAMS2/model/Result_csv/sensib_AMS/sensib8ter_sanstaxecarbone_biogaz10_sansCompoEner"
...
wbname = c("S1 AMS",
          # "S2 prix bas","S3 pop", "S4 CCE basse",  "S5 efficacité", "S6 comp-" ,"S7 comp+","S8 INV-",
           "S9 noTC","S9 noTC biog50","S9 noTC biog10", paste0("S",10:(length(wbfiles))))

### choix du scenario de référence 

scenario_ref =c("S1 AMS")
# scenario_toexport_list = c("S1 AMS","S2 prix bas","S3 pop", "S4 CCE basse",  "S5 efficacité", "S6 comp-" ,"S7 comp+","S8 INV-")
scenario_toexport_list = c("S9 noTC","S9 noTC biog50", "S9 noTC biog10")

scenario_sansCEE = c( "S1 AMS")
scenario_comp_AMS = c("S1 AMS",
                      #"S2 prix bas","S3 pop", "S4 CCE basse",  "S5 efficacité", "S6 comp-" ,"S7 comp+","S8 INV-",
                       "S9 noTC","S9 noTC biog50", "S9 noTC biog10")


### chemin où on exporte les résultats 
wbdir_scenario_toexport = c("../AME_AMS_dataDGEC/AMS 2018/test_sensib/")
write_excel =T

#scenarioshortnames = substring(wbname,1,2)
#scenarioshortnames = c("S1 AMS","S2 prix bas","S3 pop", "S4 CCE basse",  "S5 efficacité", "S6 comp-" ,"S7 comp+", "S8 INV-",paste0("S",9:(length(wbfiles))))
scenarioshortnames = wbname


scenariolabels = c("S1 AMS" = "AMS", 
                   "S2 prix bas"= "prix-",
                   "S3 pop"="Pop+", 
                   "S4 CCE basse" = "CCE-", 
                   "S5 efficacité" ="Eff-", 
                   ...
                   "S8 INV-" = "INV-", 
                   "S9 noTC" = "noTC",
                  "S9 noTC biog50" ="noTC biog50", 
                  "S9 noTC biog10" = "noTC biog10")
...
# FICHE RESULTATS TESTS SENSIB AMS
...
#     
#     write.table(comp_AMS_usage_energie[scenario==scenario_toexport],file = paste0(wbdir_scenario_toexport,scenariolabels[scenario_toexport],"_comp_cibleAMS_usage_energie.csv"),quote = F,sep=";",row.names = F, dec=",")
#   }
# }
...
ggplot(PM_syst[scenario == scenario_toexport_list[1]]) +
           geom_bar(aes(annee,PM_syst , fill = SYSTEME_CHAUD), stat="identity") +
           facet_wrap(~scenario, nrow = 1) +
           mytheme_facet_plot+ theme(legend.position = "top")+
...
FE_AMS_biog50 = data.table(read_excel("../tertiaire/parametrage modèle/Facteuremissions_thema_biog50.xls", sheet = "FEexportAMS"))
FE_AMS_biog10 = data.table(read_excel("../tertiaire/parametrage modèle/Facteuremissions_thema_biog10.xls", sheet = "FEexportAMS"))
...
FE_AMS_biog50 = melt(FE_AMS_biog50,id.vars = c("energie","usage"),value.name = "FE_AMS_biog50",variable.name = "annee")
FE_AMS_biog50[,annee:=as.character(annee)]

FE_AMS_biog10 = melt(FE_AMS_biog10,id.vars = c("energie","usage"),value.name = "FE_AMS_biog10",variable.name = "annee")
FE_AMS_biog10[,annee:=as.character(annee)]
...
Em_nationale_energie_type_usage = merge(Em_nationale_energie_type_usage , FE_AMS_biog50,by=c("energie","usage","annee"))
Em_nationale_energie_usage = merge(Em_nationale_energie_usage, FE_AMS_biog50,by=c("energie","usage","annee"))
Em_nationale_energie_type_usage = merge(Em_nationale_energie_type_usage , FE_AMS_biog10,by=c("energie","usage","annee"))
Em_nationale_energie_usage = merge(Em_nationale_energie_usage, FE_AMS_biog10,by=c("energie","usage","annee"))



Em_nationale_energie_type_usage[,EmMtCO2 := conso_tWhEF*FE_AMS*10^9*10^-12]
Em_nationale_energie_usage[,EmMtCO2 := conso_tWhEF*FE_AMS*10^9*10^-12]
Em_nationale_energie_type_usage[,EmMtCO2_socio := conso_tWhEF*FE_AMS*10^9*10^-12]
Em_nationale_energie_usage[,EmMtCO2_socio := conso_tWhEF*FE_AMS*10^9*10^-12]
Em_nationale_energie_type_usage[scenario =="S9 noTC biog50",EmMtCO2_socio := conso_tWhEF*FE_AMS_biog50*10^9*10^-12]
Em_nationale_energie_usage[scenario =="S9 noTC biog50",EmMtCO2_socio:= conso_tWhEF*FE_AMS_biog50*10^9*10^-12]
Em_nationale_energie_type_usage[scenario =="S9 noTC biog50",EmMtCO2 := conso_tWhEF*FE_AMS_biog50*10^9*10^-12]
Em_nationale_energie_usage[scenario =="S9 noTC biog50",EmMtCO2:= conso_tWhEF*FE_AMS_biog50*10^9*10^-12]
Em_nationale_energie_type_usage[scenario =="S9 noTC biog10",EmMtCO2_socio := conso_tWhEF*FE_AMS_biog10*10^9*10^-12]
Em_nationale_energie_usage[scenario =="S9 noTC biog10",EmMtCO2_socio:= conso_tWhEF*FE_AMS_biog10*10^9*10^-12]
Em_nationale_energie_type_usage[scenario =="S9 noTC biog10",EmMtCO2 := conso_tWhEF*FE_AMS_biog10*10^9*10^-12]
Em_nationale_energie_usage[scenario =="S9 noTC biog10",EmMtCO2:= conso_tWhEF*FE_AMS_biog10*10^9*10^-12]
...
ggplot(Em_nationale_usage) +
           geom_bar(aes(annee, EmMtCO2_socio, fill = usage, color = usage), stat="identity") +
           facet_wrap(~scenario, nrow = 1) +
           mytheme_facet_plot+ theme(legend.position = "top") +
  scale_x_discrete(breaks = seq(2010,2050,5), labels =
                    seq(2010,2050,5)) 
...
ggplot(Em_nationale_usage[usage=="Chauffage"]) + geom_line(aes(annee,  EmMtCO2_socio, group=scenario,color= scenario), size = 3) + 
     mytheme_facet_plot  + ylab("Emissions en MtCO2") + 
    scale_x_discrete(breaks = seq(2010,2050,5), labels =
                    seq(2010,2050,5))  + xlab("") + 
...
ggsave("../AME_AMS_dataDGEC/AMS 2018/test_sensib/Em_chauffage_sensib.png",width = 24, height=12)
...
Em_nationale[annee == "2050", EmMtCO2_socio := EmMtCO2_socio*10]
Em_nationale_usage[annee == "2050", EmMtCO2_socio := EmMtCO2_socio*10]
Em_nationale[annee%in% 2015:2050, sum(EmMtCO2_socio), by="scenario"]
Em_nationale_usage[annee%in% 2015:2050 & usage=="Chauffage", sum(EmMtCO2_socio), by="scenario"]
...
Em_nationale[annee == "2030",]
Em_nationale[annee == "2040",]
Em_nationale[annee == "2050",]
Em_nationale_usage[usage=="Chauffage"&annee == "2030", sum(EmMtCO2_socio), by="scenario"]
Em_nationale_usage[usage=="Chauffage"&annee == "2040", sum(EmMtCO2_socio), by="scenario"]
Em_nationale_usage[usage=="Chauffage"&annee == "2050", sum(EmMtCO2_socio), by="scenario"]
