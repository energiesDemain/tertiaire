...
##### prix des energies ####
prix_energie = fread("../AME_AMS_dataDGEC/parametrage modele/Prix_scenario_AME_BV_01_2017.csv", 
                     dec = ",")
...
#wbfiles[2] =  
#"../tertiaire/model/Result_Excel/table_resultat_2030_sanspol_Cref_3_5_travauxadd.xls"



#wbfiles[length(wbfiles) +1 ] =  
#  "../_CGDD_Packaging_27.05.15/Result_Excel/resultats_sauvegarde/décret_tertiaire/table_resultat_AME_décret_60p.xls"
#wbfiles[length(wbfiles) +1 ] =  
#  "../_CGDD_Packaging_27.05.15/Result_Excel/resultats_sauvegarde/décret_tertiaire/table_resultat_AME_décret_80p.xls"
#wbfiles[length(wbfiles) +1 ] =  
#  "../_CGDD_Packaging_27.05.15/Result_Excel/resultats_sauvegarde/décret_tertiaire/table_resultat_AME_décret_80p_400euros.xls"


#### noms des scenarios ###
wbname = c("S1 : AME 2016"
          ,"S2 : AME 2017 run 1"
          ,"S3 : AME 2017 run 2 CEE CC"  
#            ,"S4 : AME 2017 all pol + CC")
...
scenario_ref = c("S2 : AME 2017 run 1")
scenario_toexport = c("S3 : AME 2017 run 2 CEE CC" )
wbdir_scenario_toexport = c("../tertiaire_to_export/resultats_AME_run2/2050_allpol_CEE_CC/")
wbdir_scenario_besoins = c("../tertiaire_to_export/resultats_AME_run2/2050_allpol_CEE_CC/Result_csv/")
...
Besoin_RT_PERIODE = fread(paste0(wbdir_scenario_besoins,"export_BESOIN_RT_PERIODE.csv"), 
                          colClasses = list("character"= c("COD_BRANCHE","COD_PERIODE_SIMPLE","COD_ENERGIE")))

Besoin_RT_PERIODE[,scenario := scenario_toexport]

Conso_NON_RT_PERIODE = fread(paste0(wbdir_scenario_besoins,"export_CONSO_NON_RT_PERIODE.csv"), 
                                colClasses =
                                  list("character"=c("COD_BRANCHE","COD_PERIODE_SIMPLE","COD_ENERGIE")))
...
Besoin_branche_usage_energie_periode[,scenario := scenario_toexport]
...
Besoin_branche_usage_energie = Besoin_branche_usage_energie_periode[,list(CONSO_TOT = sum(CONSO_TOT), BESOIN_TOT = sum(BESOIN_TOT)), by=c("COD_BRANCHE","annee","usage","COD_ENERGIE","scenario")]
...
Surf_clim= fread(paste0(wbdir_scenario_besoins,"export_SURFACES_CLIM.csv"), 
                 colClasses =
                                  list("character"=c("COD_BRANCHE","COD_SYSTEME_FROID")))
...
calage_parc_ener_2010 [, calage :=calage_parc_ener_2010 [,3]/calage_parc_ener_2010 [,5]]

calage_parc_ener_2010 [, calage2 :=calage_parc_ener_2010 [,3]/calage_parc_ener_2010 [,6]]
...
calage_parc_ener_2013 [, calage :=calage_parc_ener_2013 [,3]/calage_parc_ener_2013 [,5]]
calage_parc_ener_2013 [, calage2 :=calage_parc_ener_2013 [,3]/calage_parc_ener_2013 [,6]]
