...
#wbfiles[2] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2050_decret_ECS_Eclairage_PAC"
#wbfiles[3] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2050_AMS_run3"

### nouvelle version
# AME new
#wbfiles  = "../tertiaire/model/Result_csv/run3_AME/2050_AME_DV25"
wbfiles  = "../tertiaire/model/Result_csv/run_5_AMS/2050_AME"

# AMS1 new
#wbfiles[2]   = "../tertiaire/model/Result_csv/run3_AME/2050_AMS_DV25"
# AMS2 
#wbfiles[2]   = "../tertiaire/model/Result_csv/run2_AMS/2050_allpol"
# AMS3
#wbfiles[4]   = "../tertiaire/model/Result_csv/run2_AMS/2050_run4"
#wbfiles[4]   = "../tertiaire/model/Result_csv/run2_AMS/2050_run4_CEEfort_decret2050"
#wbfiles[3]   = "../tertiaire/model/Result_csv/run2_AMS/2050_run4_CEEfort_decret2050_constructionneuveok"
#wbfiles[4]   = "../tertiaire/model/Result_csv/run2_AMS/2050_run4_CEEfort_decret2050_constructionneuveok_prixurbainok_suburbain30p"
wbfiles[2]   = "../tertiaire/model/Result_csv/run2_AMS/2050_run4_CEEfort_decret2050_constructionneuveok_prixurbainok_suburbain20p"
wbfiles[3]   = "../tertiaire/model/Result_csv/run_5_AMS/2030_testsansCEE"
#wbfiles[4]   = "../tertiaire/model/Result_csv/run_5_AMS/2030_sub23_sansCEE_croissCEE07p"
#wbfiles[4]   = "../tertiaire/model/Result_csv/run_5_AMS/2030_sub23_sansCEE_croissCEE07p_NewprixGaz"
#wbfiles[4]   = "../tertiaire/model/Result_csv/run_5_AMS/2050_croissCEE07p_PrixBiogaz100"
#wbfiles[4]   = "../tertiaire/model/Result_csv/run_5_AMS/2030_croissCEE07p_Prixbiogaz150_subGab10p"
#wbfiles[4]   = "../tertiaire/model/Result_csv/run_5_AMS/2050_croissCEE07p_Prixbiogaz150_subGab30p"
#wbfiles[4]   = "../tertiaire/model/Result_csv/run_5_AMS/2050_croissCEE07p_Prixbiogaz150_subGab30p_ORmoins"
wbfiles[3]   = "../tertiaire/model/Result_csv/run_5_AMS/2030_croissCEE12p_PrixBiogaz150"
wbfiles[3]   = "../tertiaire/model/Result_csv/run_5_AMS/2030_croissCEE12p_PrixBiogaz150"
wbfiles[3]   = "../tertiaire/model/Result_csv/run_5_AMS/2050_croissCEE12p5p"
wbfiles[3]   = "../tertiaire/model/Result_csv/run_5_AMS/2050_croissCEE12p7p_subPAC20p"
wbfiles[3]   = "../tertiaire/model/Result_csv/run_5_AMS/2050_croissCEE12p7p_subPAC15p"

# wbfiles[4]   = "../tertiaire/model/Result_csv/run_5_AMS/2030_croissCEE12p_PrixBiogaz150"
# wbfiles[4]   = "../tertiaire/model/Result_csv/run_5_AMS/2050_croissCEE12p_PrixBiogaz150"



#wbfiles[5]   = "../tertiaire/model/Result_csv/run2_AMS/2050_decretseul_prixconstant"
#wbfiles[6]   = "../tertiaire/model/Result_csv/run2_AMS/2050_decretlibere"

####### noms des scenarios ########

wbname = c( paste0("S",1:length(wbfiles)))
  
wbname = c("AME","AMS2","AMS3",  paste0("S",5:(length(wbfiles))))
...
# 
scenario_ref =c(  "AME")
scenario_toexport = c("AMS3")
scenario_sansCEE = c( "AME")
scenario_comp_AMS = c("AME","AMS2","AMS3")

# scenario_ref =c(  "AME")
# scenario_toexport = c("AME")
# scenario_sansCEE = c( "AME")
# scenario_comp_AMS = c("AME","AMS1","AMS2","AMS3")

#wbdir_scenario_toexport = c("../AME_AMS_dataDGEC/AMS 2018/run 2/")
## wbdir_scenario_toexport = c("../AME_AMS_dataDGEC/AMS 2018/run 1/")
#wbdir_scenario_toexport = c("../AME_AMS_dataDGEC/AMS 2018/run 1 new model/")
wbdir_scenario_toexport = c("../AME_AMS_dataDGEC/AMS 2018/run 5 new model/")
# wbdir_scenario_toexport = c("../AME_AMS_dataDGEC/AMS 2018/AME_new_model/")

write_excel =T

scenarioshortnames = substring(wbname,1,2)
scenarioshortnames = c("AME","AMS2","AMS3", paste0("S",5:(length(wbfiles))))
...
parc_toutesannees = dcast.data.table(parc_toutesannees,scenario+periodeconsDGEC ~annee)
...
evolbesoinu_usage = evolbesoinu_usage_type[, list(value = sum(value), Surface=sum(Surface)), by=c("scenario", "annee","Usage_MEDPRO2")]
...
evolbesoinu_usage = dcast.data.table(evolbesoinu_usage, scenario + Usage_MEDPRO2 ~ annee,value.var = "BESOIN_U")

evolbesoinu_usage = 
  evolbesoinu_usage[,list(scenario, Usage_MEDPRO2,
...
setnames(evolbesoinu_usage, c("scenario", "usage",annee_MEDPRO))
...
#### Consommations et besoins clim ECS
...
cout_geste[GAIN!=0,list(GAIN_moy = meaCOD_SYSTEME_CHAUDn(GAIN,na.rm=T), COUT_moy = mean(COUT,na.rm=T)) , by="GESTE"]
...
write.table(  dcast.data.table(INV_aides_cum[scenario == scenario_toexport], scenario + Type_Fin ~ annee,value.var = "INV_tot"), 
              paste0(wbdir_scenario_toexport,"Inv_aides.csv"),quote = T,row.names = F, sep=";", dec=".")
