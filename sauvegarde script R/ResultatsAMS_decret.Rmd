...
# AMS1 new
#wbfiles  = "../tertiaire/model/Result_csv/run3_AME/2050_AMS_DV25"
# AMS2 
wbfiles   = "../tertiaire/model/Result_csv/run2_AMS/2050_allpol"
# AMS3
#wbfiles[4]   = "../tertiaire/model/Result_csv/run2_AMS/2050_run4"
wbfiles[2]  = "../tertiaire/model/Result_csv/run2_AMS/2050_run4_CEEfort"
wbfiles[3]   = "../tertiaire/model/Result_csv/run2_AMS/2050_decretlibere"

wbfiles[4]   = "../tertiaire/model/Result_csv/run2_AMS/2050_decretseul_prixconstant"
...
wbname = c("decret 2050","decret 2030","decret lib","decret seul",  paste0("S",5:(length(wbfiles))))
...
scenario_ref =c(  "S1")
scenario_toexport = c("S3")
scenario_sansCEE = c( "S1")
scenario_comp_AMS = c("S1","S2","S3","S4","S5","S6")

scenario_ref =c("decret 2050")
scenario_toexport = c("decret 2050")
scenario_sansCEE = c( "decret seul")
scenario_comp_AMS = c("decret 2050","decret 2030","decret lib","decret seul")
...
wbdir_scenario_toexport = c("../AME_AMS_dataDGEC/AMS 2018/run 3 new model/")

write_excel =F

scenarioshortnames = substring(wbname,1,2)
scenarioshortnames =c("decret 2050","decret 2030","decret lib","decret seul", paste0("S",5:(length(wbfiles))))
