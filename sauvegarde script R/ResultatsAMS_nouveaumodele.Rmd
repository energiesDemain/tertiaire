...
wbfiles[2]   = "../tertiaire/model/Result_csv/run3_AME/2050_AME_DV25"
#wbfiles[2] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2020_AME"
# wbfiles[3] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2050_test_decret"
# wbfiles[4] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2050_testdecret_ECS"
#wbfiles[3] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2050_testdecret_ECS_PBI"
#wbfiles[4] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2050_decretrenforce"
#wbfiles[4] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2050_decret_ECS_Eclairage"
# wbfiles[3] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2050_decret_ECS_Eclairage_PAC"
# wbfiles[4]   = "../tertiaire/model/Result_csv/run3_AME/2050_AMS_DV25"
wbfiles[3] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2050_AMS_run3"
wbfiles[4]   = "../tertiaire/model/Result_csv/run2_AMS/2050_allpol"
wbfiles[5]   = "../tertiaire/model/Result_csv/run2_AMS/2050_allpol_lambda2050_1"
wbfiles[6]   = "../tertiaire/model/Result_csv/run2_AMS/2050_allpol_lambda2050_1_CEEfort"

#wbfiles[5] = "../tertiaire/model/Result_csv/calage_cout_geste/2050_AMS2"
#wbfiles[6] = "../tertiaire/model/Result_csv/calage_cout_geste/2030_decretrenforceonly"
...
scenario_ref =c(  "S1")
scenario_toexport = c("S2")
scenario_sansCEE = c( "S1")
scenario_comp_AMS = c("S1","S2","S3","S4","S5","S6")
...
write.table(dcast.data.table(Surfaces_renov_gestes_cum[scenario == scenario_toexport], scenario+Geste ~ annee, value.var = "surface"),"../AME_AMS_dataDGEC/AMS 2018/surfaces_renov_geste_AMS.csv",quote = T,dec = ".",sep=";", row.names= F)
write.table(dcast.data.table(Surfaces_renov_gestes_cum[scenario == scenario_toexport], scenario+Geste ~ annee, value.var = "INV"),"../AME_AMS_dataDGEC/AMS 2018/INV_renov_geste_AMS.csv",quote = T,dec = ".",sep=";", row.names= F)

write.table(dcast.data.table(Surfaces_renov_syst_cum[scenario == scenario_toexport], scenario+SYSTEME_CHAUD ~ annee, value.var = "surface"),"../AME_AMS_dataDGEC/AMS 2018/run 1/surfaces_renov_syst_AMS.csv",quote = T,dec = ".",sep=";", row.names= F)
write.table(dcast.data.table(Surfaces_renov_syst_cum[scenario == scenario_toexport], scenario+SYSTEME_CHAUD ~ annee, value.var = "INV"),"../AME_AMS_dataDGEC/AMS 2018/run 1/INV_syst_geste_AMS.csv",quote = T,dec = ".",sep=";", row.names= F)
...
if(write_excel ==T){
write.table(Tab_inv_DGEC_all[scenario == scenario_toexport] , "../AME_AMS_dataDGEC/AMS 2018/run 1/Inv_type_DGEC_AMS.csv",quote = T,row.names = F, sep=";", dec=".")
}
...
writeWorksheet(wb, dcast.data.table(surface_brancheMEDPRO[scenario == scenario_toexport, list(Surface = sum( Surface)), by=c("Branche_MEDPRO","annee")], Branche_MEDPRO ~ annee),  sheet="hypothèses hors modèles", startRow = 29, startCol = 10)
