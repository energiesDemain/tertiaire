...
# wbfiles[2] = "../tertiaire/model/Result_csv/calage_cout_geste/NRFlambda1_noCINTsyst"
# wbfiles[3] = "../tertiaire/model/Result_csv/calage_cout_geste/NRFlambdacroissantparbranche_coutsystOrig"
# wbfiles[4] = "../tertiaire/model/Result_csv/calage_cout_geste/NRFlambdacroissantparbranche_coutsystmodif2"
# wbfiles[5] = "../tertiaire/model/Result_csv/calage_cout_geste/New_AME_test"
# wbfiles  = "../tertiaire/model/Result_csv/calage_conso/2015_sanscalconso"
#wbfiles  = "../tertiaire/model/Result_csv/calage_conso/2015_sanscalconsoParc_DV25"
# wbfiles[2] = "../tertiaire/model/Result_csv/calage_conso/2015_sanscalconso_DV25"
# wbfiles[3] = "../tertiaire/model/Result_csv/calage_cout_geste/calage_cout_syst_DV30"
# wbfiles[4] = "../tertiaire/model/Result_csv/calage_cout_geste/New_AME_test"
wbfiles[2] = "../tertiaire/model/Result_csv/calage_conso/2050_AME_DV25"


# wbfiles[3] ="../tertiaire_versionAME/tertiaire/model/Result_csv/2050_decret_ECS_Eclairage_PAC"
# wbfiles[4] = "../tertiaire/model/Result_csv/calage_cout_geste/2050_AMS2"


# wbfiles[3] = "../tertiaire/model/Result_csv/calage_cout_geste/New_AME_sansTrav"
# wbfiles[4] = "../tertiaire/model/Result_csv/calage_cout_geste/New_AME_sansTrav_sansOREtat"
# wbfiles[5] = "../tertiaire/model/Result_csv/calage_cout_geste/New_AME_sansCEE"
# wbfiles[6] = "../tertiaire/model/Result_csv/calage_cout_geste/New_AME_sansRTex"
# wbfiles[7] = "../tertiaire/model/Result_csv/calage_cout_geste/New_AME_sansIFC"
# wbfiles[7] = "../tertiaire/model/Result_csv/calage_cout_geste/2050_AMS2"
...
calage_parc_2010[, calage2 := calage_parc_2010[,3]/calage_parc_2010[,5]]
...
calage_parc_ener_2010 [, calage2 :=calage_parc_ener_2010 [,3]/calage_parc_ener_2010 [,5]]
...
calage_parc_ener_2013 [, calage :=calage_parc_ener_2013 [,3]/calage_parc_ener_2013 [,4]]
calage_parc_ener_2013 [, calage2 :=calage_parc_ener_2013 [,3]/calage_parc_ener_2013 [,5]]
...
PM_bati = PM_bati_branche[, list(Surface_Renov=sum(Surface_Renov), Surface_parc_exi = sum(Surface_parc_exi)), by=c("scenario","annee","typeRenovationBatiment")]
PM_bati[typeRenovationBatiment != "NRF", PM_Geste := Surface_Renov/Surface_parc_exi,by=c("scenario","annee")]
PM_bati[typeRenovationBatiment=="NRF", PM_Geste := 1- Surface_Renov/Surface_parc_exi,by=c("scenario","annee")]
PM_bati[ , sum(PM_Geste), by=c("scenario","annee")]


NRF_all = dcast(PM_bati[typeRenovationBatiment=="NRF"],scenario  ~ annee, value.var = "PM_Geste")
```
...
```{r, echo=F, warning=F,}
pander(NRF_branche[,c("scenario","branche",as.character( c(2010:2020,2030,2040,2050)))] , digits = 3, caption = "Part du geste ne rien faire par branche")
```
```{r, echo=F, warning=F,}
pander(NRF_all[,c("scenario",as.character( c(2010:2020,2030,2040,2050)))] , digits = 3, caption = "Part du geste ne rien faire (parc existant)")
```
