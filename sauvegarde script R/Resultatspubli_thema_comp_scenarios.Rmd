...
wbname = c("S0 Nopol","S1 Prix","S2 REF","S3 SIM",  paste0("S",4:(length(wbfiles))))

### choix du scenario de référence 

scenario_ref =c("S0 Nopol")
scenario_toexport = c("S3 SIM")
scenario_sansCEE = c( "S0 Nopol")
scenario_comp_AMS = c("S0 Nopol","S1 Prix","S2 REF","S3 SIM")

wbdir_scenario_toexport = c("../publication_thema/run_AMS/")
write_excel =T

scenarioshortnames = substring(wbname,1,2)
scenarioshortnames = c("S0 Nopol","S1 Prix","S2 REF","S3 SIM", paste0("S",4:(length(wbfiles))))
scenarioshortnames = wbname


scenariolabels = c("S0 Nopol" = "S0", "S1 Prix" = "Prix", 
                   "S2 REF"= "REF","S3 SIM"="SIM")
...
Em_nationale_energie_type_usage[scenario =="S3 SIM",EmMtCO2_socio := conso_tWhEF*FE_AMS*10^9*10^-12]
Em_nationale_energie_type_usage[scenario !="S3 SIM",EmMtCO2_socio := conso_tWhEF*FE_AME*10^9*10^-12]
Em_nationale_energie_usage[scenario =="S3 SIM",EmMtCO2_socio := conso_tWhEF*FE_AMS*10^9*10^-12]
Em_nationale_energie_usage[scenario !="S3 SIM",EmMtCO2_socio := conso_tWhEF*FE_AME*10^9*10^-12]
...
bilan_socio[scenario=="S3 SIM" & energie == "Electricité",sub_elec := conso_tWhEF*Taxe_elec*10^-3]

test =  bilan_socio[scenario %in% c("S2 REF","S3 SIM")]
...
## facture
table_results_socio[scenario == "REF",Fact :=bilan_socio_cum2[scenario == "S2 REF",Depense_socio_AME_actu] ]
table_results_socio[scenario == "SIM",Fact :=bilan_socio_cum2[scenario == "S3 SIM",Depense_socio_AMS_actu] ]
table_results_socio[scenario == "REF prix SIM",Fact :=bilan_socio_cum2[scenario == "S2 REF",Depense_socio_AMS_actu] ]
table_results_socio[scenario == "SIM prix REF",Fact :=bilan_socio_cum2[scenario == "S3 SIM",Depense_socio_AME_actu] ]

## INV
table_results_socio[scenario == "REF",INV :=bilan_socio_cum2[scenario == "S2 REF", INV_Md_actu] ]
table_results_socio[scenario == "SIM",INV :=bilan_socio_cum2[scenario == "S3 SIM",INV_Md_actu] ]
table_results_socio[scenario == "REF prix SIM",INV :=bilan_socio_cum2[scenario == "S2 REF",INV_Md_actu] ]
table_results_socio[scenario == "SIM prix REF",INV :=bilan_socio_cum2[scenario == "S3 SIM",INV_Md_actu] ]

## EMissions
table_results_socio[scenario == "REF",Em :=bilan_socio_cum2[scenario == "S2 REF",Emiss_Mt_AME_actu] ]
table_results_socio[scenario == "SIM",Em :=bilan_socio_cum2[scenario == "S3 SIM",Emiss_Mt_AMS_actu] ]
table_results_socio[scenario == "REF prix SIM",Em :=bilan_socio_cum2[scenario == "S2 REF",Emiss_Mt_AMS_actu] ]
table_results_socio[scenario == "SIM prix REF",Em :=bilan_socio_cum2[scenario == "S3 SIM",Emiss_Mt_AME_actu] ]
...
#### recettes taxes
table_results_socio[scenario == "REF",TC :=bilan_socio_cum2[scenario == "S2 REF",Recettes_TC_AME_actu] ]
table_results_socio[scenario == "SIM",TC :=bilan_socio_cum2[scenario == "S3 SIM",Recettes_TC_AMS_actu] ]
table_results_socio[scenario == "REF prix SIM",TC :=bilan_socio_cum2[scenario == "S2 REF",Recettes_TC_AMS_actu] ]
table_results_socio[scenario == "SIM prix REF",TC :=bilan_socio_cum2[scenario == "S3 SIM",Recettes_TC_AME_actu] ]

table_results_socio[scenario == "REF",Taxes_ener :=bilan_socio_cum2[scenario == "S2 REF",Recettes_taxes_ener_AME_actu] ]
table_results_socio[scenario == "SIM",Taxes_ener :=bilan_socio_cum2[scenario == "S3 SIM",Recettes_taxes_ener_AMS_actu] ]
table_results_socio[scenario == "REF prix SIM",Taxes_ener :=bilan_socio_cum2[scenario == "S2 REF",Recettes_taxes_ener_AMS_actu] ]
table_results_socio[scenario == "SIM prix REF",Taxes_ener :=bilan_socio_cum2[scenario == "S3 SIM",Recettes_taxes_ener_AME_actu] ]

table_results_socio[scenario == "SIM",sub_elec :=bilan_socio_cum2[scenario == "S3 SIM",Subvention_elec_actu] ]
table_results_socio[scenario == "REF",sub_elec :=bilan_socio_cum2[scenario == "S2 REF",Subvention_elec_actu] ]
table_results_socio[scenario == "REF prix SIM",sub_elec :=bilan_socio_cum2[scenario == "S3 SIM",Subvention_elec_actu] ]
table_results_socio[scenario == "SIM prix REF",sub_elec :=bilan_socio_cum2[scenario == "S2 REF",Subvention_elec_actu] ]
...
bilan_socio_cum[, Diff_AMS_AME := get("S3 SIM")-get("S2 REF")]
bilan_socio_cum[, Diff_AME_nopol := get("S2 REF")-get("S1 Prix")]
...
## facture
table_results_usager[scenario == "REF",Fact :=bilan_usager_cum2[scenario == "S2 REF",Depense_usager_AME_actu] ]
table_results_usager[scenario == "SIM",Fact :=bilan_usager_cum2[scenario == "S3 SIM",Depense_usager_AMS_actu] ]
table_results_usager[scenario == "REF prix SIM",Fact :=bilan_usager_cum2[scenario == "S2 REF",Depense_usager_AMS_actu] ]
table_results_usager[scenario == "SIM prix REF",Fact :=bilan_usager_cum2[scenario == "S3 SIM",Depense_usager_AME_actu] ]

## INV
table_results_usager[scenario == "REF",INV :=bilan_usager_cum2[scenario == "S2 REF", INV_Md_actu] ]
table_results_usager[scenario == "SIM",INV :=bilan_usager_cum2[scenario == "S3 SIM",INV_Md_actu] ]
table_results_usager[scenario == "REF prix SIM",INV :=bilan_usager_cum2[scenario == "S2 REF",INV_Md_actu] ]
table_results_usager[scenario == "SIM prix REF",INV :=bilan_usager_cum2[scenario == "S3 SIM",INV_Md_actu] ]

## EMissions
table_results_usager[scenario == "REF",Em :=bilan_usager_cum2[scenario == "S2 REF",Emiss_Mt_AME_actu] ]
table_results_usager[scenario == "SIM",Em :=bilan_usager_cum2[scenario == "S3 SIM",Emiss_Mt_AMS_actu] ]
table_results_usager[scenario == "REF prix SIM",Em :=bilan_usager_cum2[scenario == "S2 REF",Emiss_Mt_AMS_actu] ]
table_results_usager[scenario == "SIM prix REF",Em :=bilan_usager_cum2[scenario == "S3 SIM",Emiss_Mt_AME_actu] ]
...
# bilan_usager_cum[, Diff_AMS_AME := get("S3 SIM")-get("S2 REF")]
# 
...
graph_taxes = bilan_socio[scenario %in% c("S2 REF","S3 SIM")]
graph_taxes[scenario %in% c("S2 REF") ,TC := Recettes_TC_AME]
graph_taxes[scenario %in% c("S3 SIM") ,TC := Recettes_TC_AMS]

graph_taxes[scenario %in% c("S2 REF") ,Taxe_ener_graph := Recettes_taxes_ener_AME]
graph_taxes[scenario %in% c("S3 SIM") ,Taxe_ener_graph :=  Recettes_taxes_ener_AMS]


write.table(table_results_socio[, list(scenario,Fact,INV,COFP,CoutTot_COFP,Em,CoutTonne_COFP, CoutTot, CoutTonne)],
            file = "../publication_thema/présentation/bilan_socio_AMS.csv",quote = T, sep=";",row.names = F)
write.table(table_results_socio[, list(scenario, TC,Taxes_ener,sub_elec,COFP)],
            file = "../publication_thema/présentation/bilan_Etat_AMS.csv",quote = T, sep=";",row.names = F)

write.table(table_results_usager[, list(scenario, Fact,INV,CoutTot)],
            file = "../publication_thema/présentation/bilan_usager_AMS.csv",quote = T, sep=";",row.names = F)
